      ...
      return Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(content, style: bodyTextStyle.copyWith(height: 1.5)),
            ),
          ],
        ),
      );
          ...
          children: [
            ...
            Center(
              child: Obx(() {
                ...
                // 手动修复重阳节显示问题
                if (controller.selectedDate.month == 10 &&
                    controller.selectedDate.day == 9 &&
                    !line.contains('重阳')) {
              ...
              children: [
                Column(
                  children: [
                    ...
                    Obx(
                      () =>
                          buildYiJiRow('忌', controller.jiList.value, redColor),
                    ),
                  ],
                ),
                Container(
...
Widget _buildInfoCard(
  AlmanacDetailController controller,
  Color darkTextColor,
  Color lightTextColor,
  Color borderColor,
  Color auspiciousColor,
) {
  final TextStyle gridTitleStyle = TextStyle(
    fontSize: 14,
    color: darkTextColor,
    fontWeight: FontWeight.bold,
  );
  final TextStyle gridTextStyle = TextStyle(
    fontSize: 14,
    color: lightTextColor,
    height: 1.5,
  );
  ...
  Widget buildSubCell(String title, String content) {
    final titleStyle = gridTitleStyle.copyWith(color: auspiciousColor);
    final contentStyle = gridTextStyle.copyWith(
      color: darkTextColor,
      height: 1.6,
    );
    return Padding(
              ...
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: buildCell(
                      '五行',
                      controller.wuXing.value.replaceAll('五行\n', ''),
                    ),
                  ),
                ),
                Expanded(
                  child: Container(
                    ...
                    child: buildCell(
                      '冲煞',
                      controller.chongSha.value.replaceAll('冲煞\n', ''),
                    ),
                  ),
                ),
                Expanded(
                  child: buildCell(
                    '值神',
                    controller.zhiShen.value.replaceAll('值神\n', ''),
                  ),
                ),
              ],
            ),
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: buildSubCell(
                              '今日胎神',
                              controller.taiShen.value.replaceAll(
                                '今日胎神\n\n',
                                '',
                              ),
                            ),
                    ...
                    SizedBox(
                      ...
                      child: buildSubCell(
                        '彭祖百忌',
                        controller.baiLu.value.replaceAll('彭祖百忌\n\n', ''),
                      ),
                    ),
                  ],
                ),
...
Widget _buildHourGrid(
  ...
  return Column(
    ...
    children: [
      Row(
        children: [
          Container(width: 4, height: 20, color: auspiciousColor),
      ...
      Obx(
        () => GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final Color statusColor = status == '吉'
                ? auspiciousColor
                : redColor;
